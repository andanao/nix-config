# Edit this configuration file to define what should be installed on your system.  Help is available in the configuration.nix(5) man page and 
...
{ imports =
  ...
  users.users.cygnus = { isNormalUser = true; description = "cygnus"; extraGroups = [ "networkmanager" "wheel" ]; packages = with pkgs; [
    #  thunderbird
    ];
  };
  ...
  # your system were taken. It‘s perfectly fine and recommended to leave this value at the release version of the first install of this system. 
